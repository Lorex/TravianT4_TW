...
if (mysqli_num_rows(mysqli_query($con,"SELECT id FROM ".TB_PREFIX."users WHERE access = 9 AND id = ".$session->uid)) != '1') die("Hacking attemp!");
	...
	//Aanvallers v/d Week
    $result = mysqli_query($con,"SELECT * FROM ".TB_PREFIX."users WHERE id > 3 ORDER BY ap DESC Limit 10");
	...
	//Verdediger v/d Week
    $result = mysqli_query($con,"SELECT * FROM ".TB_PREFIX."users WHERE id > 3 ORDER BY dp DESC Limit 10");
    $i=0; 	while($row = mysqli_fetch_array($result)){
	$i++;	$img="t3_".($i)."";
    ...
    $result = mysqli_query($con,"SELECT * FROM ".TB_PREFIX."users WHERE id > 3 ORDER BY clp DESC Limit 10");
    $i=0;     while($row = mysqli_fetch_array($result)){
    $i++;    $img="t1_".($i)."";
    ...
    $result = mysqli_query($con,"SELECT * FROM ".TB_PREFIX."users WHERE id > 3 AND RR >= 0 ORDER BY RR DESC Limit 10");
    $i=0; 	while($row = mysqli_fetch_array($result)){
	$i++;	$img="t4_".($i)."";
    ...
    while($row = mysqli_fetch_array($result)){
        ...
        $result2 = mysqli_query($con,"SELECT * FROM ".TB_PREFIX."users WHERE id > 3 ORDER BY dp DESC Limit 10");
    ...
    $result = mysqli_query($con,"SELECT * FROM ".TB_PREFIX."users WHERE id > 3 ORDER BY Rc DESC Limit 10");
    while($row = mysqli_fetch_array($result)){
	...
	//Zet alle waardens weer op 0
	 ...
	 mysqli_query($con,"UPDATE ".TB_PREFIX."users SET ap=0, dp=0,Rc=0,clp=0, RR=0 WHERE id = ".$row[0]."");
	}

    //Start alliance Medals wooot

	//Aanvallers v/d Week
    $result = mysqli_query($con,"SELECT * FROM ".TB_PREFIX."alidata ORDER BY ap DESC Limit 10");
    $i=0;     while($row = mysqli_fetch_array($result)){
    $i++;    $img="a2_".($i)."";
    ...
    //Verdediger v/d Week
    $result = mysqli_query($con,"SELECT * FROM ".TB_PREFIX."alidata ORDER BY dp DESC Limit 10");
    $i=0;     while($row = mysqli_fetch_array($result)){
    $i++;    $img="a3_".($i)."";
    ...
    $resul=mysqli_query($con,$quer);
      ...
      //Overvallers v/d Week
    $result = mysqli_query($con,"SELECT * FROM ".TB_PREFIX."alidata AND RR >= 0 ORDER BY RR DESC Limit 10");
    $i=0;     while($row = mysqli_fetch_array($result)){
    $i++;    $img="a4_".($i)."";
    ...
    //Rank climbers of the week
    $result = mysqli_query($con,"SELECT * FROM ".TB_PREFIX."alidata ORDER BY clp DESC Limit 10");
    $i=0;     while($row = mysqli_fetch_array($result)){
    $i++;    $img="a1_".($i)."";
    ...
    $resul=mysqli_query($con,$quer);
     ...
     $result=mysqli_query($con,$query);
     for ($i=0; $row=mysqli_fetch_row($result); $i++){
     mysqli_query($con,"UPDATE ".TB_PREFIX."alidata SET ap=0, dp=0, RR=0, clp=0 WHERE id = ".$row[0]."");
    }
	}
/**
