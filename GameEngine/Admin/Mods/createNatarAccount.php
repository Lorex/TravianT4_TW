...
$wid = mysqli_fetch_assoc(mysqli_query($con,"SELECT * FROM ".TB_PREFIX."vdata WHERE owner = $uid"));
...
mysqli_query($con,$q3) or die(mysqli_error());
$q4 = "UPDATE " . TB_PREFIX . "users SET desc2 = '$desc' WHERE id = $uid";
mysqli_query($con,$q4) or die(mysqli_error());
