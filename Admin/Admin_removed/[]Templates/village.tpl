			...
			<tbody>
				...
				<?php
					...
					if($isthere >0)
					{
						...
						{
							$oasiswref = $row['wref'];
							$oasisx = mysqli_result(mysqli_query($con,"SELECT x FROM ".TB_PREFIX."wdata WHERE id = ".$oasiswref.""), 0);
							$oasisy = mysqli_result(mysqli_query($con,"SELECT y FROM ".TB_PREFIX."wdata WHERE id = ".$oasiswref.""), 0);
