...
$sql = mysqli_query($con,"SELECT * FROM $prefix WHERE finish = 0 AND owner = $session->uid ORDER BY time ASC");
...
$sql2 = mysqli_query($con,"SELECT * FROM $prefix WHERE proc = 0 AND uid = $session->uid");
...
$sql = mysqli_query($con,"SELECT * FROM $prefix WHERE finish = 1 and owner = $session->uid ORDER BY time ASC");
...
$sql2 = mysqli_query($con,"SELECT * FROM $prefix WHERE finish = 1 and owner = $session->uid ORDER BY time DESC $limit");
