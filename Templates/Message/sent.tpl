...
$sql = mysqli_query($con,"SELECT * FROM $prefix WHERE owner = $session->uid  AND delowner = 0 ORDER BY time DESC");
...
$sql2 = mysqli_query($con,"SELECT * FROM $prefix WHERE owner = $session->uid AND delowner = 0 ORDER BY time DESC $limit");
$paginationDisplay = "";
